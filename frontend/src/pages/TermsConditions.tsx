    ...
    <section className="max-w-4xl mx-auto p-6 prose text-cream">
        ...
        <section className="font-teachers mt-10">
            <section>
                ...
                Gentalks is a student-led online community dedicated to generational empowerment through supportive and nurturing conversations, primarily serving high school students but open to all users.
                </p>
            </section>
            ...
            <section className="mt-4">
                ...
                <p className="p-4 text-lg">
                Gentalks does not impose any age restrictions on users. However, users under the age of 18 are advised that the platform is an online space which may expose them to risks such as cyberbullying, cyberattacks, and other online safety concerns. Minors are encouraged to use the platform under the supervision or guidance of a trusted adult.
                </p>
            </section>
            ...
            <section>
                <h2 className="font-semibold text-2xl">5. User Conduct</h2>
                <p className="p-4 text-lg">
