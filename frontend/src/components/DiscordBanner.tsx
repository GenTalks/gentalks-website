...
const JoinDiscordSection = () => {
  return (
    <section className="border-0 border-cream bg-laurel text-cream py-16 px-8 rounded-3xl max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 shadow-lg flex-wrap">
      ...
      <div className="flex flex-col items-center lg:items-start gap-6 max-w-3xl text-center lg:text-left">
        ...
        <p className="text-lg md:text-xl leading-relaxed font-teachers">
          an online space for growth, where members uplift each other and share
          valuable insights on careers and life.
        </p>
        <DiscordButton />
      </div>
    </section>
